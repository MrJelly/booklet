...
function d(t, e) {
    ...
    return t.forEach(function(t) {
        if (null !== t.data[e] && "undefinded" != typeof t.data[e]) {
            var n = {};
            n.color = t.color, n.name = t.name, n.seryname = t.seryname, n.index = e, n.data = t.format ? t.format(t.data[e]) : t.data[e], 
            i.push(n);
        }
    }), i;
}
...
function g(t, e, i, n, a) {
    var o = arguments.length > 5 && void 0 !== arguments[5] ? arguments[5] : {}, r = t.map(function(t) {
        return {
            text: o.format ? o.format(t, n[i], a[i]) : t.name + ": " + t.data,
            color: t.color
        };
    }), s = [], l = {
        x: 0,
    ...
    return e.forEach(function(t) {
        "undefinded" != typeof t[i] && null !== t[i] && s.push(t[i]);
    }), s.forEach(function(t) {
        l.x = Math.round(t.x), l.y += t.y;
    }), l.y /= s.length, {
        textList: r,
        offset: l
    };
...
function F(t, e, i) {
    var n = i.yAxisWidth + i.yAxisTitleWidth, a = (e.width - i.padding - n) / (e.enableScroll ? Math.min(5, t.length) : t.length), o = [], r = i.yAxisTitleWidth + i.padding / 2, s = e.width - i.padding / 2;
...
function k(t, e, i, n, a, o) {
    if (n.beginPath(), n.setLineWidth(1), n.setFillStyle(e), "diamond" === i) t.forEach(function(t, e) {
        null !== t && (n.moveTo(t.x, t.y - 4.5), n.lineTo(t.x - 4.5, t.y), n.lineTo(t.x, t.y + 4.5), 
        n.lineTo(t.x + 4.5, t.y), n.lineTo(t.x, t.y - 4.5));
    }); else if ("circle" === i) {
        n.setFillStyle(a), t.forEach(function(t, e) {
            null !== t && (o && "" != o ? t.val > 0 && (n.moveTo(t.x + 3, t.y), n.arc(t.x, t.y, 3, 0, 2 * Math.PI, !1)) : (n.moveTo(t.x + 3, t.y), 
            n.arc(t.x, t.y, 3, 0, 2 * Math.PI, !1)));
        }), o && "" != o && (n.closePath(), n.fill(), n.stroke(), n.beginPath(), n.setFillStyle(o), 
        t.forEach(function(t, e) {
            null !== t && t.val <= 0 && (n.moveTo(t.x + 3, t.y), n.arc(t.x, t.y + .5, 3, 0, 2 * Math.PI, !1));
        }));
    } else "rect" === i ? t.forEach(function(t, e) {
...
function X(t, e, i, n) {
    var a = arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : 1, o = C(t, e, i).ranges, r = F(e.categories, e, i), s = r.xAxisPoints, l = r.eachSpacing, h = o.pop(), c = o.shift();
...
function R(t, e, i, n) {
    var a = arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : 1, r = C(t, e, i).ranges, s = F(e.categories, e, i), l = s.xAxisPoints, h = s.eachSpacing, c = r.pop(), f = r.shift(), d = e.height - i.padding - i.xAxisHeight - i.legendHeight, x = [];
    return n.save(), e._scrollDistance_ && 0 !== e._scrollDistance_ && !0 === e.enableScroll && n.translate(e._scrollDistance_, 0), 
...
function q(t, e, i, n) {
    var a = arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : 1, r = C(t, e, i).ranges, s = F(e.categories, e, i), l = s.xAxisPoints, h = s.eachSpacing, c = r.pop(), f = r.shift(), d = [];
    return n.save(), e._scrollDistance_ && 0 !== e._scrollDistance_ && !0 === e.enableScroll && n.translate(e._scrollDistance_, 0), 
    e.tooltip && e.tooltip.textList && e.tooltip.textList.length && 1 === a && W(e.tooltip.offset.x, e, i, n), 
    t.forEach(function(t, r) {
        var s = w(t.data, c, f, l, h, e, i, a);
        if (d.push(s), S(s).forEach(function(i, a) {
            n.beginPath(), n.setStrokeStyle(t.color), n.setLineWidth(.5), 1 === i.length ? (n.moveTo(i[0].x, i[0].y), 
            ...
            var x = t.dataPointShape;
            x || (x = i.dataPointShape[r % i.dataPointShape.length]);
            var u = t.dataPointFillColor || "", g = t.emptyPointFillColor || "";
            k(s, t.color, x, n, u, g);
        }
    }), !1 !== e.dataLabel && 1 === a && t.forEach(function(t, o) {
        I(w(t.data, c, f, l, h, e, i, a), t, i, n);
...
function N(t, e, i, n) {
    ...
    t.forEach(function(t, e) {
        ...
        var h = c(t), f = s / 2 - h, d = a(r[o] + s / 2, l + i.fontSize / 2 + 5, e.height);
        d.transX, d.transY;
        n.fillText(t, r[o] + f, l + i.fontSize + 5), n.closePath(), n.stroke(), n.restore();
    }), n.restore();
}

function j(t, e, i) {
    var n = t.height - 2 * e.padding - e.xAxisHeight - e.legendHeight, a = Math.floor(n / e.yAxisSplit), o = e.yAxisWidth + e.yAxisTitleWidth, r = t.width, s = [];
    if (t.yAxis.disableGrid && 1 == t.yAxis.disableGrid) for (var l = 0; l < e.yAxisSplit; l++) s.push(e.padding + a * l);
    s.push(e.padding + a * e.yAxisSplit + 2), i.beginPath(), i.setStrokeStyle(t.yAxis.gridColor || "#cccccc"), 
    i.setLineWidth(.5), s.forEach(function(t, e) {
        i.moveTo(o, t), i.lineTo(r, t);
    }), i.closePath(), i.stroke();
}

function Y(t, e, i, n) {
    if (!0 !== e.yAxis.disabled) {
        var a = C(t, e, i).rangesFormat, o = i.yAxisWidth + i.yAxisTitleWidth, r = e.height - 2 * i.padding - i.xAxisHeight - i.legendHeight, s = Math.floor(r / i.yAxisSplit), l = i.padding + o, h = e.width - i.padding, h = e.width, c = e.height - i.padding - i.xAxisHeight - i.legendHeight;
...
function V(t, e, i, n) {
    ...
    switch (this.animationInstance && this.animationInstance.stop(), t) {
      case "line":
        j(e, i, n);
        var u = q(o, e, i, n, 1), g = u.xAxisPoints, p = u.calPoints, y = u.eachSpacing;
        a.chartData.xAxisPoints = g, a.chartData.calPoints = p, a.chartData.eachSpacing = y, 
        N(r, e, i, n), Z(e.series, e, i, n), Y(o, e, i, n), B(e, i, n, 1), Q(e, n);
        break;
      ...
      case "column":
        this.animationInstance = new U({
            ...
            onProcess: function(t) {
                j(e, i, n);
                var s = X(o, e, i, n, t), l = s.xAxisPoints, h = s.eachSpacing;
                a.chartData.xAxisPoints = l, a.chartData.eachSpacing = h, N(r, e, i, n), Z(e.series, e, i, n), 
                Y(o, e, i, n), Q(e, n);
            },
      ...
      case "area":
        this.animationInstance = new U({
            ...
            onProcess: function(t) {
                ...
                N(r, e, i, n), Z(e.series, e, i, n), Y(o, e, i, n), B(e, i, n, t), Q(e, n);
            },
            onAnimationFinish: function() {
                a.event.trigger("renderComplete");
            }
    ...
    if ("line" === this.opts.type || "area" === this.opts.type) {
        ...
        if (n > -1) {
            ...
            if (0 === r.length) V.call(this, o.type, o, this.config, this.context); else {
                var s = g(r, this.chartData.calPoints, n, this.opts.categories, this.opts.categoryNames, i), l = s.textList, h = s.offset;
                o.tooltip = {
                    textList: l,
                    offset: h,
                    option: i
